...
{
    public partial class frmCustomerDataRecord1 : Form
    {
        public frmCustomerDataRecord1()
        {
            InitializeComponent();
        }
        ...
        private void dataGridView1_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
                ...
                frm.Show();
                frm.txtCustID.Text = dr.Cells[0].Value.ToString();
                frm.txtCustName.Text = dr.Cells[1].Value.ToString();
